...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p>Thank you for subscribing to <strong>SSvid Premium</strong>!</p>
  ...
  <p style="color: #999; font-size: 12px;">SSvid — Desktop Video Downloader<br>support@ssvid.app</p>
</body>
</html>`))
...
<html>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #1a1a1a;">Your SSvid Premium License</h2>
  ...
  <p>Enter this key in SSvid → Settings → Premium to activate your subscription on any device.</p>
  <hr style="border: none; border-top: 1px solid #eee; margin: 20px 0;">
  <p style="color: #999; font-size: 12px;">SSvid — Desktop Video Downloader<br>support@ssvid.app</p>
</body>
</html>`))
...
<html>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #1a1a1a;">Your SSvid Premium Expires Soon</h2>
  <p>Your SSvid Premium subscription will expire in <strong>{{.DaysRemaining}} days</strong>.</p>
  <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
    <tr><td style="padding: 8px; border-bottom: 1px solid #eee; color: #666;">License Key</td><td style="padding: 8px; border-bottom: 1px solid #eee;"><code>{{.LicenseKey}}</code></td></tr>
    <tr><td style="padding: 8px; border-bottom: 1px solid #eee; color: #666;">Expires</td><td style="padding: 8px; border-bottom: 1px solid #eee;">{{.ExpiresAt}}</td></tr>
  ...
  <p><a href="https://ssvid.app" style="display: inline-block; background: #4F46E5; color: #fff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 600;">Visit SSvid</a></p>
  <hr style="border: none; border-top: 1px solid #eee; margin: 20px 0;">
  <p style="color: #999; font-size: 12px;">SSvid — Desktop Video Downloader<br>support@ssvid.app</p>
</body>
</html>`))
...
<html>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #1a1a1a;">Your {{if eq .Brand "vidcombo"}}VidCombo{{else}}SSvid{{end}} sign-in link</h2>
  ...
  <hr style="border: none; border-top: 1px solid #eee; margin: 20px 0;">
  <p style="color: #999; font-size: 12px;">If you didn't request this link, ignore this email. The link will expire on its own.<br>{{if eq .Brand "vidcombo"}}VidCombo{{else}}SSvid{{end}} — Desktop Video Downloader<br>support@ssvid.app</p>
</body>
</html>`))
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <hr style="border: none; border-top: 1px solid #eee; margin: 20px 0;">
  <p style="color: #999; font-size: 12px;">SSvid Support Team<br>support@ssvid.app</p>
</body>
</html>`))
}
