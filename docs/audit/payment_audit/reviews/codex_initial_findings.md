...
File: /projects/ssvid_app/backend/internal/premium/handler/premium_handler.go:685
...
File: /projects/ssvid_app/backend/internal/premium/service/stripe_service.go:515
...
File: /projects/ssvid_app/backend/internal/premium/service/crypto_service.go:110
Trigger: Submit a crypto invoice request for a billing cycle allowed by the DTO but unsupported for the resolved brand, such as SSvid `semiannual` or VidCombo `lifetime1`; `AmountCentsForBillingCycle` returns `0`, and `CreateInvoice` formats and sends `0.00` USD to BTCPay.
...
File: /projects/ssvid_app/backend/internal/premium/handler/webhook_handler.go:405
...
File: /projects/ssvid_app/backend/internal/premium/repository/webhook_event_repository.go:43
...
File: /projects/ssvid_app/backend/internal/premium/handler/webhook_handler.go:229
...
File: /projects/ssvid_app/backend/internal/premium/service/premium_service.go:122
...
Impact: SSvid and VidCombo entitlements can be used across products despite separate prices and plans, creating underpayment and brand/revenue contamination.
...
File: /projects/ssvid_app/backend/internal/premium/dto/premium_request.go:16
...
Fix: Replace the fixed 45-character validator with a prefix-aware license-key validator, or allow the full known range for SSvid and VidCombo keys.
